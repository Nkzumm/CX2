...
if (strpos($resp, 'Card successfully deleted.')) {
 ...
 if (strpos($bruxo, 'We’re sorry. We’re unable to complete your Prime signup at this time. Please try again later.')) {
    ...
    echo "<font style=color:#00ff88><span class='badge badge-soft-success'>Aprovadas </span> ➔ $cc|$mes|$ano|$cvv</font>➜REMOVIDO:$msg<font style=color:#00ff88>$nome</font> ➜ <font style=color:#00ff88>$bin ➔ Retorno: <span class='badge badge-soft-success'>[CARTAO APROVADO]</span><b>Tempo de Resposta: (" . (time() - $time) . " SEG) ➔ @bruxo_dev77</b></font><br>";
    ...
    echo "<font style=color:#f6ff00><span class='badge badge-soft-danger'>Reprovadas </span> ➔ $cc|$mes|$ano|$cvv</font>➜REMOVIDO:$msg<font style=color:#f6ff00>$nome</font> ➜ <font style=color:#f6ff00>$bin ➔ Retorno: <span class='badge badge-soft-danger'>[CARD INVALIDO] </span><b>Tempo de Resposta: (" . (time() - $time) . " SEG) ➔ @bruxo_dev77</b></font><br>";
    curl_close($curl);
    exit();

} elseif (strpos($bruxo, 'HARDVET_VERIFICATION_FAILED')) {

    echo "<font style=color:#f6ff00><span class='badge badge-soft-danger'>Reprovadas </span> ➔ $cc|$mes|$ano|$cvv</font>➜REMOVIDO:$msg<font style=color:#0789f2>$nome</font> ➜ <font style=color:#f6ff00>$bin ➔ Retorno: <span class='badge badge-soft-warning'>[PAGAMENTO RECUSADO]</span><b>Tempo de Resposta: (" . (time() - $time) . " SEG) ➔ @bruxo_dev77</b></font><br>";
    curl_close($curl);
    exit();
} else {
    echo "<font style=color:#ff0000 0><span class='badge badge-soft-danger'>Reprovadas </span> ➔ $cc|$mes|$ano|$cvv</font>➜REMOVIDO:$msg<font style=color:#ff0000>$nome</font> ➜ <font style=color:#ff0000>$bin ➔ Retorno: <span class='badge badge-soft-warning'>[COOKIE CAIU]</span><b>Tempo de Resposta: (" . (time() - $time) . " SEG) ➔ @bruxo_dev77</b></font><br>";
    curl_close($curl);
    exit();
